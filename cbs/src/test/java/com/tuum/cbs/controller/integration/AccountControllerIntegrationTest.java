...
//    @Test()
//    public void getAccountITestShouldReturnNotFound() throws URISyntaxException, JsonProcessingException {
//        // make post request first
//        AccountDao accountDao = new AccountDao(customerId, country, currencies);
//        uri = new URI(baseUrl + "/accounts/account-open");
//        ResponseEntity<SuccessResponse> postResponseEntity = restTemplate.postForEntity(uri, accountDao, SuccessResponse.class);
...
//        });
////        ResponseEntity<ErrorResponse> getResponseEntity = restTemplate.getForEntity(url, ErrorResponse.class, params);
////        System.out.println(getResponseEntity);
////        // final assertions
////        assertThat(getResponseEntity).isNotNull();
////        assertThat(getResponseEntity.getBody()).isNotNull();
////        assertEquals(getResponseEntity.getStatusCode(), HttpStatusCode.valueOf(500));
//    }
